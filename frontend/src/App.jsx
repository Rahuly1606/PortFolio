    ...
    <div>
      ...
      >
        ...
        <div className="absolute inset-0 overflow-hidden">
          {/* Gradient background */}
          <div className="absolute inset-0 bg-gradient-to-br from-white via-blue-50 to-indigo-50 opacity-80"></div>
          ...
          <motion.div 
            className="absolute -top-20 -left-20 w-96 h-96 bg-gradient-radial from-indigo-300/40 to-transparent rounded-full mix-blend-multiply filter blur-3xl"
            animate={{ 
              scale: [1, 1.1, 1],
              x: [0, 10, 0],
              y: [0, 15, 0],
          ...
          <motion.div 
            className="absolute bottom-0 right-0 w-80 h-80 bg-gradient-radial from-blue-300/40 to-transparent rounded-full mix-blend-multiply filter blur-3xl"
            animate={{ 
              scale: [1, 1.2, 1],
              x: [0, -20, 0],
              y: [0, -10, 0],
          ...
          <motion.div 
            className="absolute top-1/2 left-1/3 w-72 h-72 bg-gradient-radial from-purple-300/30 to-transparent rounded-full mix-blend-multiply filter blur-3xl"
            animate={{ 
              scale: [1, 1.15, 1],
              x: [0, 15, 0],
              y: [0, -15, 0],
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8 flex flex-col lg:flex-row items-center justify-between relative z-10">
          ...
          >
            <motion.div
              ...
              className="inline-block px-6 py-2 mb-6 rounded-full bg-indigo-100 text-indigo-800 font-medium text-sm shadow-soft"
            >
            ...
            <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-4 text-shadow-lg whitespace-nowrap">
            ...
            <motion.p
              ...
              className="mt-4 text-xl text-gray-600 leading-relaxed max-w-xl"
            >
            ...
            >
              <motion.a
                ...
                className="btn-primary px-8 py-3 rounded-full shadow-lg hover:shadow-indigo-500/50 transition-all duration-300 group"
              >
                <span className="flex items-center gap-2">
                  View Projects
            ...
            <div className="relative translate-x-12 lg:translate-x-24">
              ...
              >
                ...
                {[...Array(5)].map((_, i) => (
                  <motion.div
                    key={i}
                    className="absolute rounded-lg bg-white shadow-xl p-4 border-l-4 border-indigo-500 text-sm font-mono text-gray-800 w-48"
                    style={{
                      top: `${20 + i * 15}%`,
                      left: `${15 + (i % 3) * 12}%`,
                      zIndex: 5 - i,
                  ...
                  >
                    ...
                    {i === 0 && <div className="text-indigo-600">function App() &#123;</div>}
                    {i === 1 && <div className="text-blue-600">const [state, setState] = useState();</div>}
                    {i === 2 && <div className="text-green-600">return &lt;Component /&gt;;</div>}
                    {i === 3 && <div className="text-purple-600">useEffect(function() &#123; ... &#125;);</div>}
                    {i === 4 && <div className="text-indigo-600">&#125; // End of App</div>}
                  </motion.div>
                ))}
              ...
              <motion.div
                ...
                className="absolute -bottom-10 -left-10 flex items-center gap-2 rounded-full bg-white px-4 py-2 shadow-lg"
              >
                <img src={skills[skillIndex].icon} alt={skills[skillIndex].name} className="h-5 w-5" />
                <span className="text-sm font-medium text-gray-900">{skills[skillIndex].name}</span>
              </motion.div>
              ...
              <motion.div
                ...
                className="absolute top-1/2 -right-10 bg-white rounded-full p-2 shadow-lg"
              >
      ...
      >
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-white to-indigo-50 opacity-80"></div>
          ...
          >
            ...
            >
              <p className="mt-4 text-lg text-gray-800 leading-relaxed">
                🚀 I'm a passionate <span className="font-semibold text-indigo-600">Full-Stack Developer</span> with a knack for building
            ...
            >
              <p className="mt-4 text-lg text-gray-700 leading-relaxed">
                With expertise in <span className="text-indigo-600 font-semibold">React, Node.js</span>, and modern web technologies,
            ...
            <motion.div
              ...
              transition={{ duration: 0.5, delay: 0.6 }}
            >
              <p className="mt-6 text-lg font-medium italic bg-gradient-to-r from-indigo-600 to-blue-500 bg-clip-text text-transparent">
            ...
            >
              ...
              {[
                ...
                <motion.div
                  ...
                  className="bg-white rounded-lg p-4 shadow-md flex flex-col items-center w-32"
                >
                  <span className="text-3xl font-bold bg-gradient-to-r from-indigo-600 to-blue-500 bg-clip-text text-transparent">{stat.value}</span>
      ...
      >
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-12 relative z-10">
          ...
          >
            <motion.a
              href="#"
              className="inline-flex items-center px-8 py-3 rounded-full bg-white text-indigo-600 font-medium border border-indigo-100 shadow-md hover:shadow-lg transition-all duration-300"
              whileHover={{ scale: 1.05, boxShadow: "0 10px 25px -5px rgba(0, 0, 0, 0.1)" }}
              whileTap={{ scale: 0.95 }}
            >
      ...
      >
        {/* Background elements */}
        <div className="absolute inset-0 bg-gradient-to-br from-white to-indigo-50"></div>
        <div className="absolute inset-0 opacity-5" style={{ 
          backgroundImage: "url('/code-pattern.svg')",
        }}></div>
                ...
                {programmingLanguages.map((skill, index) => (
                  ...
                  >
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className="text-sm font-bold text-indigo-600">{skill.progress}%</span>
                    </div>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-12 relative z-10">
          ...
          >
            ...
            <motion.p
              ...
              className="text-lg text-gray-700 mt-4 max-w-2xl mx-auto"
            >
              Check out my coding profiles and development platforms where I showcase my problem-solving skills.
            </motion.p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {links.map((link, index) => (
              <motion.a
                ...
                className="group bg-white rounded-2xl p-6 shadow-lg flex items-center gap-6 transition-all duration-300"
              >
          ...
          >
            ...
            >
              ...
              >
                ...
                <span className="font-medium text-gray-900">Follow me on GitHub</span>
              </a>
            </motion.div>
          </motion.div>
        </div>
